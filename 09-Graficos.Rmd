...
Acredito que nesse exemplo, é fácil verificar:
  ...
  > ⚠️ **Cuidado ao conferir:** por padrão o R fecha as classes **à direita**, isto é, os intervalos são (30, 40], (40, 50], e assim por diante. Por isso o valor 40 conta na classe *30 - 40*, e não na classe *40 - 50*. O único elemento da segunda classe é o 46.
