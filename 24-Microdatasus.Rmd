...
O script completo, comentado, está disponível junto com o material do livro, em `scripts/dados-nascimentos.R`. Ele é curto e você pode adaptá-lo trocando duas linhas:
