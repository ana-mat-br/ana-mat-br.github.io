...
1. **Baixe o banco de dados**  
   Use o banco de dados [Pokemon.csv](https://ana-mat-br.github.io/dados/Pokemon.csv).  
...
Considere a tabela de resultados publicados no artigo [Resposta da Pressão Arterial ao Esforço em Adolescentes: Influência do Sobrepeso e Obesidade](https://www.scielo.br/j/abc/a/fZQ7mr4h3B6gyVY4h6PvWyN/?lang=pt):
...
>
> Se quiser converter, basta tirar a raiz quadrada: para a dimensão *Dor*, $t = \sqrt{4{,}33} = 2{,}08$.
>
