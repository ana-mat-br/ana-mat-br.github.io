...
Coletar dados custa tempo e dinheiro. Um TCC que dependa de coleta própria pode levar um semestre inteiro só na etapa de aplicar questionários, e ainda esbarrar em comitê de ética, em recusa de participantes e em perda amostral.

Com dados abertos, você pula essa etapa e chega direto à pergunta. Foi assim que montamos o banco de nascimentos de Uberaba: em poucos minutos, sem coletar nada, tínhamos 3.602 registros reais para trabalhar. Isso não substitui a pesquisa de campo, mas é um caminho legítimo e muito usado --- boa parte da produção em epidemiologia é feita com dados secundários.

\begin{quote}
\textbf{Atenção:} usar dado aberto não dispensa cuidado ético nem citação. O banco tem autoria, tem uma finalidade original e tem limitações. Cite a fonte, leia a documentação e não force o dado a responder uma pergunta que ele não pode responder.
\end{quote}
