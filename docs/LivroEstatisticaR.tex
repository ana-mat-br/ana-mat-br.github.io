...
O R, por sua vez, não adivinha onde as coisas estão. Se você simplesmente pedir ``abra o arquivo dos nascimentos'', ele não sabe em qual das centenas de pastas do computador procurar. \textbf{Você precisa dizer onde o arquivo está} --- e é só isso que aquelas linhas de código com barras e aspas estão fazendo.
