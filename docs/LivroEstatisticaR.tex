...
Os exemplos anteriores usaram o \texttt{mcdonald}, que serve bem para aprender o mecanismo da importação. Agora vamos repetir os mesmos três passos --- importar, olhar uma variável, resumir o banco --- em um banco da \textbf{sua} área. Escolha o seu abaixo; os três estão na pasta \texttt{dados/} do material.
