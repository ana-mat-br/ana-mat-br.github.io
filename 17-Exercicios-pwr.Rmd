...
- **effsize**: valor do tamanho de efeito calculado, aqui 0.206.  
  - Este valor segue a interpretação dos tamanhos de efeito r:  
    - 0.10 = pequeno, 0.30 = moderado, 0.50 = grande.
...
- O grupo "Green" tende a apresentar velocidades um pouco maiores que o grupo "Yellow", mas a diferença é considerada pequena. **Observe que isso contradiz o boxplot!**
- Sempre avalie se essa diferença é relevante no contexto do seu estudo ou aplicação.
...
**Classificação da magnitude do efeito**

, segundo Romano et al. (2006)
