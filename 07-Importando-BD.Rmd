...
Os exemplos anteriores usaram o `mcdonald`, que serve bem para aprender o mecanismo da importação. Agora vamos repetir os mesmos três passos — importar, olhar uma variável, resumir o banco — em um banco da **sua** área. Escolha o seu abaixo; os três estão na pasta `dados/` do material.
