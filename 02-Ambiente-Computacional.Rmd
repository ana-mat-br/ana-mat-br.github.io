...
* **RStudio é um software** onde executaremos códigos R, é o pessoal da computação denomina de ambiente de desenvolvimento (IDE).^[Integrated Development Environment - Ambiente de Desenvolvimento Integrado]
...
2. Faça o login (eu acesso com meu usuário do Google)

3. A seguinte tela será apresentada 

<center>![<font size="2"> Tela inicial na nuvem da Posit</font>](telaPosit.png)
</center>

4. Crie um projeto RStudio, selecionando a opção New Project, e em seguida, escolhendo New RStudio Project.

<center>![<font size="2">Botão de criação de um novo projeto</font>](telaCriarProjetoRStudio.png){width=40%}
</center>

Se deu tudo certo, você verá a seguinte tela:

<center>![<font size="2"> Tela inicial do RStudio online na nuvem da Posit</font>](telaRStudioPosit.png)
</center>
