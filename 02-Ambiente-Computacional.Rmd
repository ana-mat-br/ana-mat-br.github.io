...
Neste curso, utilizaremos a linguagem **R**, desenvolvida especialmente para análise estatística. Quer entender por que essa escolha e ir além do que vemos aqui? Recomendamos: [R para Ciência de Dados](https://pt.r4ds.hadley.nz/) (livro completo e gratuito, em português) e o [material aberto da Curso-R](https://www.curso-r.com/material/).
