...
> **Se você tentar refazer a conta na mão, atenção a um detalhe:** o $\chi^2$ que entra na fórmula do V é o valor **sem** a correção de continuidade de Yates. O `chisq.test()` aplica Yates por padrão em tabelas 2x2 e devolveu 0,543 — mas $\sqrt{0{,}543/30} = 0{,}13$, e não 0,20.
